...
<%
	...
	if(session.getAttribute("loginSession")!=null) {
		...
		String jsql2 = "select MAX(tp_id) from tradepost";
		...
		String jsql3 = "insert into tradepost values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement pstmt3 = con.prepareStatement(jsql3);
		pstmt3.setInt(1,tp_no);
		pstmt3.setString(2,title);
		pstmt3.setString(3,category);
		pstmt3.setString(4,realimg);
		pstmt3.setString(5,content);
		pstmt3.setString(6,datetime);
		pstmt3.setString(7,loginID);
		pstmt3.setString(8,nickname);
		pstmt3.setInt(9,0);
		pstmt3.setInt(10,price);
		pstmt3.setString(11,condition);
		pstmt3.setString(12,dealing);
		pstmt3.setString(13,deliveryFee);
		
		pstmt3.executeUpdate();
		
		String jsql4 = "insert into tradeimg values (?, ?, ?, ?, ?)";
