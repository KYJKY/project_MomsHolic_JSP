...
<script>
	...
	function registeralert() {
		alert("컬럼글이 성공적으로 등록되었습니다.");
		location.href="sub_column.jsp";
	}
</script>
</head>
<body>
<%
	...
	if(session.getAttribute("loginSession").equals("admin")) {
		...
		String jsql2 = "select MAX(co_id) from columntbl";
		...
		String jsql3 = "insert into columntbl values (?, ?, ?, ?, ?, ?, 0, 0)";
		PreparedStatement pstmt3 = con.prepareStatement(jsql3);
		pstmt3.setInt(1,co_id);
