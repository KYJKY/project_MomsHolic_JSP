...
<header id="responsive">
 ...
 %> 알림
			...
			<!--판매하기  -->
			<section>
				<form name="goods" method="post" action="sub_donate_writeOK.jsp" enctype="multipart/form-data">
				<div id="selltop">
					<p>응모작성</p>
				</div>
				<div id="sellInfo">
					<table>
						...
						<tr>
							<td class="col1">원가</td>
							<td class="col2"><input type="number" class="inputTitle" placeholder="숫자만 입력해주세요." name="price" required></td>
						</tr>
