...
<html>
	<head>
		...
		<link href="css/sub_recipe_write.css" rel="stylesheet" type="text/css">
		...
		function readImg1(input) {
			...
			function readImg7(input) {
				if(input.files && input.files[0]) {
					var reader = new FileReader();
					reader.onload = function(e) {
						$('#previewImg7').attr('src', e.target.result);
					}
					reader.readAsDataURL(input.files[0]);
				}
			}
			function readImg8(input) {
				if(input.files && input.files[0]) {
					var reader = new FileReader();
					reader.onload = function(e) {
						$('#previewImg8').attr('src', e.target.result);
					}
					reader.readAsDataURL(input.files[0]);
				}
			}
			function readImg9(input) {
				if(input.files && input.files[0]) {
					var reader = new FileReader();
					reader.onload = function(e) {
						$('#previewImg9').attr('src', e.target.result);
					}
					reader.readAsDataURL(input.files[0]);
				}
			}
			function readImg10(input) {
				if(input.files && input.files[0]) {
					var reader = new FileReader();
					reader.onload = function(e) {
						$('#previewImg10').attr('src', e.target.result);
					}
					reader.readAsDataURL(input.files[0]);
				}
			}
...
<header id="responsive">
 ...
 %> 알림
			...
			<!--레시피 작성  -->
			<section>
				<form name="goods" method="post" action="recipeOK.jsp" enctype="multipart/form-data">
				<div id="selltop">
					<p>레시피 작성</p>
				</div>
				<div id="sellInfo">
					<table>
						...
						<tr>
							...
							<td class="col2">
								<select class="inputCategory" name="category">
									<option value="initial">초기 이유식</option>
									<option value="mid">중기 이유식</option>
									<option value="late">후기 이유식</option>
									<option value="finish">완료기 이유식</option>
									<option value="infant">유아식</option>
									<option value="snack">아이간식</option>
								</select>
							</td>
						</tr>
						<tr>
							<td class="col1">요리소개</td>
							<td class="col2"><textarea name="content" rows="3" cols="50" placeholder="요리소개를 작성해주세요." required></textarea></td>
						</tr>
						<tr>
							<td class="col1">재료</td>
							<td class="col2"><input type="text" class="inputTitle" placeholder="재료정보를 작성해주세요." name="meterial" required></td>
						</tr>
					</table>
					
					<div id="recipeStepGroup">
						<div id="recipeStepTop">
							<div id="recipeTopTitle">
								<h1>조리 순서</h1>
							</div>
						</div>
						<div id="recipeStepLine"></div>
						<div id="recipeStepTop2">
							<p>조리 순서에 맞게 각 차레별 이미지를 첨부하고 상세 설명을 작성해주세요.</p>
							<p>(꼭 10단계에 맞추실 필요없이 원하는 단계만큼 작성해주세요.)</p>
						</div>
						
						<input type="hidden" name="hiddenrow" id="hiddenrow" value="1">
						<div id="step1" class="recipeStep">
							<p>Step1</p>
							<div class="stepImg">
							...
							<div class="stepText">
								<textarea name="content1" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step2" class="recipeStep">
							<p>Step2</p>
							<div class="stepImg">
							...
							<div class="stepText">
								<textarea name="content2" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step3" class="recipeStep">
							<p>Step3</p>
							<div class="stepImg">
							...
							<div class="stepText">
								<textarea name="content3" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step4" class="recipeStep">
							<p>Step4</p>
							<div class="stepImg">
							...
							<div class="stepText">
								<textarea name="content4" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step5" class="recipeStep">
							<p>Step5</p>
							<div class="stepImg">
								<label for="filename5"><img src="images/sell/preview.png" id="previewImg5" class="imgPointer"></label>
								<input type="file" accept="images/*" name="filename5" class="uploadHidden" id="filename5" style="display:none;" onchange="readImg5(this);">
							</div>
							<div class="stepText">
								<textarea name="content5" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step6" class="recipeStep">
							<p>Step6</p>
							<div class="stepImg">
								<label for="filename6"><img src="images/sell/preview.png" id="previewImg6" class="imgPointer"></label>
								<input type="file" accept="images/*" name="filename6" class="uploadHidden" id="filename6" style="display:none;" onchange="readImg6(this);">
							</div>
							<div class="stepText">
								<textarea name="content6" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step7" class="recipeStep">
							<p>Step7</p>
							<div class="stepImg">
								<label for="filename7"><img src="images/sell/preview.png" id="previewImg7" class="imgPointer"></label>
								<input type="file" accept="images/*" name="filename7" class="uploadHidden" id="filename7" style="display:none;" onchange="readImg7(this);">
							</div>
							<div class="stepText">
								<textarea name="content7" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step8" class="recipeStep">
							<p>Step8</p>
							<div class="stepImg">
								<label for="filename8"><img src="images/sell/preview.png" id="previewImg8" class="imgPointer"></label>
								<input type="file" accept="images/*" name="filename8" class="uploadHidden" id="filename8" style="display:none;" onchange="readImg8(this);">
							</div>
							<div class="stepText">
								<textarea name="content8" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step9" class="recipeStep">
							<p>Step9</p>
							<div class="stepImg">
								<label for="filename9"><img src="images/sell/preview.png" id="previewImg9" class="imgPointer"></label>
								<input type="file" accept="images/*" name="filename9" class="uploadHidden" id="filename9" style="display:none;" onchange="readImg9(this);">
							</div>
							<div class="stepText">
								<textarea name="content9" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						<div id="step10" class="recipeStep">
							<p>Step10</p>
							<div class="stepImg">
								<label for="filename10"><img src="images/sell/preview.png" id="previewImg10" class="imgPointer"></label>
								<input type="file" accept="images/*" name="filename10" class="uploadHidden" id="filename10" style="display:none;" onchange="readImg10(this);">
							</div>
							<div class="stepText">
								<textarea name="content10" rows="3" cols="50" placeholder="상세설명을 작성해주세요." ></textarea>
							</div>
						</div>
						
					</div>
					<div id="sellButton">
						<a href="category.jsp?ctg=all"><img src="images/button/cancel2.png"></a>
