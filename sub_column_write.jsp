...
<header id="responsive">
 ...
 %> 알림
			...
			<!--판매하기  -->
			<section>
				<form name="goods" method="post" action="sub_column_writeOK.jsp" enctype="multipart/form-data">
				<div id="selltop">
					<p>칼럼작성</p>
				</div>
				<div id="sellInfo">
					<table>
						...
						<tr>
							...
							<td class="col2"><input type="text" class="inputTitle" placeholder="내용을 입력해주세요." name="name" required></td>
						</tr>


						<tr>
							<td class="col1">내용</td>
							<td class="col2"><textarea name="content" rows="10" cols="50" placeholder="내용을 입력해주세요." required></textarea></td>
						</tr>
					</table>

					<div id="sellButton">
						<a href="sub_column.jsp"><img src="images/button/cancel2.png"></a>
