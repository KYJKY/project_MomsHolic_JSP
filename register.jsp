	...
	<head>
		...
		function checkingID() {
			...
			return; 
				...
				$.ajax({
					type: 'POST',
					url: './UserRegCheckServlet',
					data: {m_id: inputed},
					success: function(result) {
						if(result == 1) {
							$("#checkID").css({"background-color":"#FFFFFF" , "margin-top":"10px"});
							$('#checkIDText').text("사용할 수 있는 아이디입니다.");
							$("#checkIDText").css("color", "green");
						}
						else {
							$("#checkID").css({"background-color":"#FFCECE" , "margin-top":"10px"});
							$('#checkIDText').text("사용할 수 없는 아이디입니다.");
...
<header id="responsive">
 ...
 %> 알림
			...
			<div id="input">
				<form name="newMem" method="post" action="./userReg">
					<h2 class="text1">아이디 생성</h2>
					<table id="table1">
						<tr>
							<td class="col1">아이디</td>
							<td class="col2">
								<input type="text" name="id" id="checkID" class="inputGroup1" placeholder="4~8자 영문/영문+숫자"  required>
								<div id="checkIDText" style="font-weight:normal;font-size:10pt"></div>
							</td>
							<td class="col3">
									<div class="checkID"><img onclick="checkingID()" src="images/button/CheckID.png" class="btnStyle"></div>
							</td>
							
						</tr>
						<tr>
							<td class="col1">비밀번호</td>
							<td class="col2" colspan="2"><input type="password" name="password1" class="inputGroup1" placeholder="8~16자 영문, 숫자, 특수문자" size="21" id="pwd"></td>
							<!-- <td class="col3"></td> -->
						</tr>
						<tr>
							<td class="col1">비밀번호확인</td>
							<td class="col2" colspan="2"><input type="password" name="password2" class="inputGroup1" placeholder="비밀번호를 다시 한번 입력해주세요" size="21" id="repwd" onblur="checkPwd()">
						...
						<tr>
							...
							<td class="col2"><input type="text" class="inputGroup1" name="nickname" id="checkNickname">
					...
					<h2 class="text1">회원 정보 입력</h2>
					<table id="table2">
						<tr>
							<td class="col1">이름</td>
							<td class="col3" colspan="2">
								<input type="text" name="Name" class="inputGroup1">
						...
						<tr>
							...
							<td class="col3 " colspan="2"><input type="date" name="birth" class="inputGroup1" placeholder="8~16자 영문, 숫자, 특수문자" size="21"></td>
						</tr>
						<tr>
							<td class="col1">핸드폰</td>
							<td class="col3" colspan="2"><input type="text" class="inputGroup1" name="Phone" placeholder=" ' - ' 제외하고 공백없이 입력" maxlength="11"></td>
						</tr>
						<tr>
							<td class="col1">이메일</td>
							<td class="col3" colspan="2">
							<input type="text" name="Email1" class="inputGroup1" placeholder="example" size="21" style="width:137px">&nbsp;@
							<input type="text" name="Email2" class="inputGroup1" placeholder="gmail.com" size="21" style="width:137px">
							</td>
						</tr>
						<tr>
							<td class="col1">우편번호</td>
							<td class="col2"><input type="text" name="addressCode" class="inputGroup1" id="addressCode" placeholder="우편번호" size="5" style="width:140px" disabled></td>
							<td class="col3">
									<div class="checkID" id="checkCode"><img onclick="addressSearch()" src="images/button/searchZipcode.png" class="btnStyle"></div>
						</tr>
						<tr>
							<td class="col1">기본주소</td>
							<td class="col3" colspan="2"><input type="text" name="address1" id="address1" class="inputGroup1" placeholder="주소" size="21" disabled></td>
						</tr>
						<tr>
							<td class="col1">상세주소</td>
							<td class="col3" colspan="2"><input type="text" name="address2" id="address2" class="inputGroup1" placeholder="상세주소" size="21"></td>
						</tr>
						
					</table>
					
					<div id="insert">
						<input type="image" src="images/button/join.png" value="submit" align="adsmiddle">
					</div>
					<a href="index.jsp">
						<div id="back"><img src="images/button/back.png"></div>
					</a>
				</form>
			</div>			
		</div>
